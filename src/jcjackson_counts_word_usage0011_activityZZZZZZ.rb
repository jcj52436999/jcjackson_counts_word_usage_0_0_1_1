...
class JcjacksonCountsWordUsage0011Activity
  def onCreate(bundle)
    super
    set_title "JC Jackson Counts Word Usage - 0.0.1.1m"
    # SOFTWARE_TITLE = "JC Jackson Counts Word Usage - 0.0.1.1m"
    # set_title SOFTWARE_TITLE.text
